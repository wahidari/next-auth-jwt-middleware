          ...
          <section className="text-gray-600 body-font py-8">
            ...
            <div className="flex justify-center md:mx-16">
              <ul className="dark:text-white">
                ...
                <li><b>Admin - First</b> & <b>Admin - Second</b> using _middleware.js inside <b>admin</b> folder that intercept request to every page inside <b>admin</b> folder. if no user was logged in automatically redirected to login page.</li>
              </ul>
            </div>
          </section>
